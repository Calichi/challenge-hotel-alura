...
public class Exito extends JDialog {
	...
	private final JLabel numeroDeReserva = new JLabel("Número de reserva: ");
	...
	public Exito() {
		...
		numeroDeReserva.setForeground(new Color (12, 138, 199));
		numeroDeReserva.setFont(new Font("Arial", Font.BOLD, 18));
		numeroDeReserva.setBounds(27, 153, 322, 21);
		contentPanel.add(numeroDeReserva);
	...
	public Exito(Reserva reserva) {
		this();

		this.numeroDeReserva.setText(String.format("Número de reserva: %s", reserva.getId()));
	}
}
