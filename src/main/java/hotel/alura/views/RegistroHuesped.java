...
public class RegistroHuesped extends JFrame {
	...
	private SelectorDeFecha txtFechaN;
	private JComboBox<Format> txtNacionalidad;
	private JLabel labelExit;
	private JLabel labelAtras;
	int xMouse, yMouse;

	ReservaController controladorReserva = App.getReservaController();
	HuespedController controladorHuesped = App.getHuespedController();
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Huesped huesped = new Huesped(getNombre(), getApellido(), getNacimiento(), getNacionalidad(), getTelefono(), reserva);
				controladorHuesped.guardar(huesped);
	...
	public RegistroHuesped(Reserva reserva) {
		...
		controladorReserva.guardar(reserva);
		this.txtNreserva.setText(Long.toString(reserva.getId()));
	}
	...
	public void regresar() {
		Exito escena = new Exito(this.reserva);
		escena.setVisible(true);
		dispose();
	}

	private String getNombre() { return txtNombre.getText(); }

	private String getApellido() { return txtApellido.getText(); }

	private Date getNacimiento() { return txtFechaN.obtenerFecha(); }

	private String getNacionalidad() { return txtNacionalidad.getSelectedItem().toString(); }

	private String getTelefono() { return txtTelefono.getText(); }
